    ...
    return (
        <div className="jumbotron">
            <div className="jumbotron-wrapper">
                 <div className="jumbotron__initial-phrase">We’ve got your morning covered with</div>
                 <div className="jumbotron__logo">Coffee</div>
                 ...
                 <a href="#" className="jumbotron__button">Order Now</a>  
            </div>  
        </div>
    )
}
