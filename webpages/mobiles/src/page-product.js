...
const reviewBtn = document.querySelector(".main-misc-feedback-user__button");
...
let removeBtn = document.getElementById("remove-article");
let cartBtn = document.querySelector(".header-widgets__basket");
