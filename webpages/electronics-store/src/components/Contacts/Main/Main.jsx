    ...
    return (
            ...
            <div className={styles.contactsCommunications}>
                <div className={styles.contactsCommunication}>
                    <div className={styles.contactsCommunicationsCaption}>
                        <img src={phone} alt="" />
                        <span className={styles.contactsCommunicationTitle}>
                            Call To Us
                        </span>
                    </div>
                    <div className={styles.contactsCommunicationDetails}>
                        We are available 24/7, 7 days a week.
                    </div>
                    <div className={styles.contactsCommunicationTouch}>
                        Phone: +8801611112222
                    </div>
                </div>
            ...
            <div className={styles.contactsFeedbackForm}>
                <form className={styles.contactsFeedbackFormWrapper}>
                    <span className={styles.contactsFeedbackFormInputs}>
                        <input
                            type="text"
                            className={styles.contactsCommunicationInput}
                    ...
                    <textarea
                        name=""
                        id=""
                        className={styles.contactsCommunicationTextarea}
                        placeholder="Your Message"
                        cols={88}
                        rows={10}
                    ></textarea>
                    <a href="#" className={styles.contactsCommunicationButton}>
                        Send Message
                    </a>
                </form>
            </div>
