  ...
  return (
    ...
    <div className="header-widgets">
        <form className="header-widgets__search">
            ...
            <a href="#" className="header-widgets__search-button"><img src={searchLens} alt="" /></a>
        </form>
        <span className="header-widgets__shopping">
          <a href="" className="header-widgets__shopping-favorites"><img src={addToFavorites} alt=""/></a>
